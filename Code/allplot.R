...
box(lty = "blank")
grid.lines(x = c(0,0), y = c(0.08,1), gp = gpar(col = "black", lwd = 2))
grid.lines(x = c(0.5,0.5), y = c(0.08,1), gp = gpar(col = "black", lwd = 2))
grid.lines(x = c(1,1), y = c(0.08,1), gp = gpar(col = "black", lwd = 2))
grid.lines(x = c(1,1), y = c(0.08,1), gp = gpar(col = "black", lwd = 2))
grid.lines(x = c(0,1), y = c(0.08,0.08), gp = gpar(col = "black", lwd = 2))
grid.lines(x = c(1,1), y = c(1,1), gp = gpar(col = "black", lwd = 2))
set.panel()
